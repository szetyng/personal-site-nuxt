              ...
              <template>
                <v-row justify="center">
                  <v-col
                    ...
                    xl="6"
                  >
                    <v-card outlined flat min-height="300">
                      <!-- Top part of card: either an image of the project or the description of the project -->
                      <!-- Image of the project  -->
                      <v-card height="250px" flat class="scroll">
                        <v-img
                          v-if="!project.expand"
                          :src="
                            require(`~/assets/images/portfolio/${project.imgSrc}`)
                          "
                          height="245px"
                          class="project-img"
                          contain
      ...
      meta: [
        {
          hid: "description",
          name: "description",
          content: "Portfolifo of Sze Tyng Lee's projects"
        }
      ]
    };
  },
      ...
      projects: [
        {
          ...
          description:
            "\
					...
					",
          url:
            "https://gist.github.com/szetyng/fedbb9008e8b607e4e4ad958b6ab657b",
          links: [
            {
        ...
        },
        {
          ...
          links: [
            {
              url:
                "https://drive.google.com/open?id=1fzMeVbB9MzWxGHrpk6X85kNun_6NYvJ8OUVmduqiQtc",
              color: "grey darken-2",
              title: "Slides"
            }
          ],
